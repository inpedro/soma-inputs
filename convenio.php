...
<table id="table4_RP"  border="1" width="100%" style="text-align:center;">
			...
			<td class="td_ValorTotalContratoCV"><input type="text" name="td_ValorTotalContratoCV" id="td_ValorTotalContratoCV" onfocus="" ></td>
			<td class="td_ValorTotalBoletimCV"><input type="text" name="td_ValorTotalBoletimCV" id="td_ValorTotalBoletimCV" onfocus="campValue()" ></td>
			<td class="td_SaldoTotalContratualCV"><input type="text" name="Std_SaldoTotalContratualCV" id="SaldoTotalContratualCV" onfocus="valorCont()" /></td>
